...
frappe.ui.form.on("Material Request", {
	setup: function (frm) {
		frm.custom_make_buttons = {
			...
			"Supplier Quotation": "Supplier Quotation",				// "Work Order": "Work Order", // Manufacturing removed
	...
	make_custom_buttons: function (frm) {
		// Manufacturing removed - Bill of Materials not available
		...
		if (frm.doc.docstatus == 1 && frm.doc.status != "Stopped") {
			...
			if (flt(frm.doc.per_ordered, precision) < 100) {
				...
				// Manufacturing removed - Work Order creation not available
