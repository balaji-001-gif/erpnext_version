...
def get_help_messages():
	...
	message_settings = [
		frappe._dict(
			...
			route="List/Quotation",		domain=("Retail", "Services", "Distribution"),
			target=3,
	),
		frappe._dict(
			doctype="Sales Order",
			...
			route="List/Sales Order",		domain=("Retail", "Services", "Distribution"),
			target=3,
	),
		frappe._dict(
			...
			route="List/Purchase Order",		domain=("Retail", "Services", "Distribution"),
			target=3,
	),
		frappe._dict(
			doctype="User",
